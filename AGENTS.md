...
- 2026-06-24：Web 端和 Taro 小程序应用名称由"算力先锋"统一改为"数学逆袭"。Web 端变更文件：`index.html`、`src/pages/Login.tsx`、`src/pages/Profile.tsx`、`src/pages/admin/AdminLogin.tsx`、`src/components/AdminLayout.tsx`、`src/pages/Agreement.tsx`。Taro 端变更文件：`platform-taro/src/app.config.ts`、`platform-taro/public/index.html`、`platform-taro/src/pages/login/index.tsx`、`platform-taro/src/pages/home/index.tsx`、`platform-taro/src/pages/profile/index.tsx`、`platform-taro/src/pages/agreement/index.tsx`、`platform-taro/src/pages/index.tsx`。执行 `npm run build:weapp` 构建成功，webapp-testing 回归测试通过。