export default defineAppConfig({
  ...
  tabBar: {
    ...
    list: [
      ...
      {
        pagePath: 'pages/daily-goals/index',
        text: '目标',
        iconPath: 'assets/tab-goal.png',
        selectedIconPath: 'assets/tab-goal-active.png'
      },
      {
        pagePath: 'pages/mistakes/index',
        text: '错题',
        iconPath: 'assets/tab-mistake.png',
        selectedIconPath: 'assets/tab-mistake-active.png'
      },
      {
